                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">
                            <a href="{{ route('admin.tanda-tangan.create') }}" class="btn btn-primary btn-sm">Tambah Tanda
                                Tangan</a>
                        </p>
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @foreach ($tandaTangan as $index => $ttd)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>{{ $ttd->ttd_name }}</td>
                ...
                button.addEventListener('click', function(e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            form.method = 'POST';
                            form.action = `{{ url('admin/tanda-tangan-remove') }}-${id}`;
                            form.innerHTML = `
                            @csrf
                            @method('DELETE')
                        `;
